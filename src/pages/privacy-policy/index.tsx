      ...
      <PrivacyPolicyContainer>
        ...
        <article>
          ...
          <PrivacySection id="section-1">
            ...
            <div>
              ...
              <ul>
                ...
                <li>
                  Content and Inquiries: Information you submit when contacting
                  support, booking a demo, or posting on our community
                  forums.{" "}
                </li>
                <li>
                  {" "}
                  Customer Data: Urban data sets you upload, which may contain
                  personal information depending on the nature of your data. We
                  process this data as a Data Processor acting on your
                  instructions.{" "}
                </li>
              </ul>
            </div>
            <div>
              ...
              <ul>
                ...
                <li>
                  ...
                  technologies to analyze trends, administer the website, and
            ...
            <div>
              ...
              <p>
                We may receive information about you from other users (e.g., an
                invitation to a project) or from publicly available sources.
              </p>
            </div>
          </PrivacySection>
          ...
          <PrivacySection id="section-3">
            ...
            <p>
              If you are located in the European Economic Area (EEA) or the UK,
              we process your personal data based on the following legal
              grounds:
            </p>
            <ul>
              <li>
                Performance of a Contract: To fulfill our obligations under the
                Terms of Service.
              </li>
              <li>
          ...
          <PrivacySection id="section-5">
            ...
            <p>
              ...
              countries not deemed to have adequate protection, we ensure
          ...
          <PrivacySection id="section-6">
            ...
            <p>
              ...
              including encryption at rest and in transit. However, no method of
          ...
          <PrivacySection id="section-7">
            ...
            <p>
              ...
              <ul>
                ...
                <li>
                  Data Portability: The right to request a transfer of your data
                  to another service.
                </li>
                <li>
